...
const RoutineDetailPage = () => {
    ...
    const completedCount = tasks.reduce((sum, t) => (getLogByTask(t.id || t.taskId)?.status === 1 ? sum + 1 : sum), 0);
    ...
    const handleAddPrepareItem = async () => {
        ...
        try {
            ...
            setNewPrepare({ name: '', description: '', purchaseUrl: '', category: 'Equipment', iconName: 'package', isRequired: true });
            fetchRoutine();
        } catch (err) {
    ...
    const handleAddTask = async () => {
        ...
        try {
            ...
            const payload = {
                ...
                restAfterSeconds: newTask.restAfterSeconds === '' ? null : parseNumber(newTask.restAfterSeconds, null),
                prepareItems: [],
            };
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans pb-24">
            <header className="p-4 flex items-center gap-3 sticky top-0 bg-black/80 backdrop-blur-md z-30">
                ...
                <div>
                    <p className="text-[10px] uppercase tracking-[0.2em] text-zinc-600 font-black">Routine Detail</p>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        <select
                                            ...
                                            onChange={(e) => setEditForm({ ...editForm, repeatType: parseInt(e.target.value, 10) })}
                                        ...
                                        <select
                                            ...
                                            onChange={(e) => setEditForm({ ...editForm, visibility: parseInt(e.target.value, 10) })}
                                            className="bg-neutral-900 border border-white/10 rounded-lg px-3 py-2 text-white text-sm"
                                        >
                                    ...
                                    {tasks.map((task) => (
                                        ...
                                        >
                                            <div className="flex items-start justify-between gap-2">
                                                ...
                                                <span className={`text-[11px] px-2 py-1 rounded-full border ${statusColor(getLogByTask(task.id || task.taskId)?.status)}`}>
                                            ...
                                            <div className="mt-3 p-3 rounded-xl bg-neutral-800 border border-white/10 space-y-2">
                                                ...
                                                <div className="grid grid-cols-3 gap-2 items-center">
                                                    <input
                                                        ...
                                                        onChange={(e) => setLogInputs((prev) => ({ ...prev, [task.id || task.taskId]: e.target.value }))}
                                                ...
                                                <div className="space-y-2">
                                                    <div className="grid grid-cols-3 gap-2 items-center">
                                                        <input
                                                            ...
                                                            onChange={(e) => setEvidenceInputs((prev) => ({ ...prev, [task.id || task.taskId]: e.target.value }))}
                                                            className="col-span-2 bg-neutral-900 border border-white/10 rounded-lg px-3 py-2 text-white text-sm"
                                                            placeholder="Evidence URL"
                                                        />
                                                        <button
                                                            onClick={() => handleEvidence(getLogByTask(task.id || task.taskId)?.id, task.id || task.taskId)}
                                                    ...
                                                    <div className="grid grid-cols-3 gap-2 items-center">
                                                        <input
                                                            ...
                                                            onChange={(e) => {
                                                                ...
                                                                setEvidenceFiles((prev) => ({ ...prev, [task.id || task.taskId]: file }));
                                                            }}
                                                ...
                                                {getLogByTask(task.id || task.taskId)?.currentValue !== undefined && (
                                                    <p className="text-[11px] text-zinc-500">Giá trị hiện tại: {getLogByTask(task.id || task.taskId)?.currentValue}</p>
                                                )}
                                            </div>
                                            ...
                                            <div className="mt-3 space-y-2">
                                                                    ...
                                                                    {editing ? (
                                                                        <div className="space-y-2">
                                                                            <input
                                                                                type="text"
                                                                                value={editing.name}
                                                                                onChange={(e) => setTaskPrepareEditing((prev) => ({ ...prev, [p.id]: { ...editing, name: e.target.value } }))}
                                                                                className="w-full bg-neutral-900 border border-white/10 rounded-lg px-3 py-2 text-white text-sm"
                                                                            />
                                                                            <textarea
                                                                                value={editing.description}
                                                                                onChange={(e) => setTaskPrepareEditing((prev) => ({ ...prev, [p.id]: { ...editing, description: e.target.value } }))}
                                                                                className="w-full bg-neutral-900 border border-white/10 rounded-lg px-3 py-2 text-white text-sm"
                                                                                rows={2}
                                                                                placeholder="Mô tả"
                                                                            />
                                                                            <input
                                                                                ...
                                                                                onChange={(e) => setTaskPrepareEditing((prev) => ({ ...prev, [p.id]: { ...editing, purchaseUrl: e.target.value } }))}
                                                                                className="w-full bg-neutral-900 border border-white/10 rounded-lg px-3 py-2 text-white text-sm"
                                                                            ...
                                                                            <div className="grid grid-cols-2 gap-2">
                                                                                <select
                                                                                    ...
                                                                                    onChange={(e) => setTaskPrepareEditing((prev) => ({ ...prev, [p.id]: { ...editing, category: e.target.value } }))}
                                                                                    className="bg-neutral-900 border border-white/10 rounded-lg px-3 py-2 text-white text-sm"
                                                                                >
                                                                                ...
                                                                                <select
                                                                                    ...
                                                                                    onChange={(e) => setTaskPrepareEditing((prev) => ({ ...prev, [p.id]: { ...editing, iconName: e.target.value } }))}
                                                                                    className="bg-neutral-900 border border-white/10 rounded-lg px-3 py-2 text-white text-sm"
                                                                                >
                                                                            ...
                                                                            <label className="inline-flex items-center gap-2 text-sm text-white">
                                                                                <input
                                                                                    ...
                                                                                    onChange={(e) => setTaskPrepareEditing((prev) => ({ ...prev, [p.id]: { ...editing, isRequired: e.target.checked } }))}
                                                                        ...
                                                                        <div className="flex items-start justify-between gap-2">
                                                                            <div className="space-y-1">
                                                                                ...
                                                                                {p.purchaseUrl && (
                                                                                    <a className="text-xs text-lime-400 hover:underline" href={p.purchaseUrl} target="_blank" rel="noreferrer">
                                                                                        Link mua
                                                                                    </a>
                                                                                )}
                                                                            ...
                                                                            <div className="flex flex-col gap-2">
                                                                                <button
                                                                                    onClick={() => setTaskPrepareEditing((prev) => ({ ...prev, [p.id]: { ...p } }))}
                                                                                    className="text-xs px-3 py-1 rounded-lg border border-white/10 text-white"
                                                                                >
                                                                                    Sửa
                                                                                </button>
                                                                                <button
                                                                                    onClick={() => handleTaskPrepareDelete(task.id || task.taskId, p.id)}
                                                ...
                                                <div className="p-3 rounded-lg bg-neutral-800 border border-white/10 space-y-2">
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => setTaskPrepareDrafts((prev) => ({ ...prev, [task.id || task.taskId]: { ...getTaskDraft(task.id || task.taskId), name: e.target.value } }))}
                                                        className="w-full bg-neutral-900 border border-white/10 rounded-lg px-3 py-2 text-white text-sm"
                                                    />
                                                    <textarea
                                                        placeholder="Mô tả (optional)"
                                                        value={getTaskDraft(task.id || task.taskId).description}
                                                        onChange={(e) => setTaskPrepareDrafts((prev) => ({ ...prev, [task.id || task.taskId]: { ...getTaskDraft(task.id || task.taskId), description: e.target.value } }))}
                                                        className="w-full bg-neutral-900 border border-white/10 rounded-lg px-3 py-2 text-white text-sm"
                                                        rows={2}
                                                    />
                                                    <input
                                                        ...
                                                        onChange={(e) => setTaskPrepareDrafts((prev) => ({ ...prev, [task.id || task.taskId]: { ...getTaskDraft(task.id || task.taskId), purchaseUrl: e.target.value } }))}
                                                        className="w-full bg-neutral-900 border border-white/10 rounded-lg px-3 py-2 text-white text-sm"
                                                    />
                                                    <div className="grid grid-cols-2 gap-2">
                                                        <select
                                                            value={getTaskDraft(task.id || task.taskId).category}
                                                            onChange={(e) => setTaskPrepareDrafts((prev) => ({ ...prev, [task.id || task.taskId]: { ...getTaskDraft(task.id || task.taskId), category: e.target.value } }))}
                                                            className="bg-neutral-900 border border-white/10 rounded-lg px-3 py-2 text-white text-sm"
                                                        >
                                                            {prepareCategoryOptions.map((opt) => (
                                                                <option key={opt} value={opt}>{opt}</option>
                                                        ...
                                                        <select
                                                            ...
                                                            onChange={(e) => setTaskPrepareDrafts((prev) => ({ ...prev, [task.id || task.taskId]: { ...getTaskDraft(task.id || task.taskId), iconName: e.target.value } }))}
                                                            className="bg-neutral-900 border border-white/10 rounded-lg px-3 py-2 text-white text-sm"
                                                        >
                                                            {[...iconOptions, 'package', 'box', 'shopping-bag'].map((icon) => (
                                                                <option key={icon} value={icon}>{icon}</option>
                                                    ...
                                                    <label className="inline-flex items-center gap-2 text-sm text-white">
                                                        <input
                                                            ...
                                                            onChange={(e) => setTaskPrepareDrafts((prev) => ({ ...prev, [task.id || task.taskId]: { ...getTaskDraft(task.id || task.taskId), isRequired: e.target.checked } }))}
                                                            className="accent-lime-400"
                                                        />
                                                        Bắt buộc
                                                    </label>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        ...
                                        <div className="flex flex-col gap-2 bg-neutral-800 border border-white/10 rounded-lg px-3 py-2">
                                            ...
                                            <span className="text-[11px] text-zinc-500">Đang chọn: <span className="text-white font-semibold">{newTask.iconColor}</span></span>
                                        </div>
                                    </div>
                                    <textarea
                                ...
                                <div className="space-y-2">
                                    ...
                                    <label className="inline-flex items-center gap-2 text-sm text-white">
                                        <input
                                            ...
                                            onChange={(e) => setNewPrepare({ ...newPrepare, isRequired: e.target.checked })}
                                            className="accent-lime-400"
                                        />
                                        Bắt buộc
                                    </label>
