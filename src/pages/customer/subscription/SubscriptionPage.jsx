...
export default function SubscriptionPage() {
  ...
  const fetchCurrentSubscription = useCallback(async (options = {}) => {
  ...
  }, [fetchCurrentSubscription, fetchPayments, stopPollingStatus]);

  useEffect(() => {
    fetchPlans();
    fetchCurrentSubscription();
    fetchPayments();
  }, [fetchPlans, fetchCurrentSubscription, fetchPayments]);
  ...
  }, [location.search, location.pathname, activeStatus, startPollingStatus, stopPollingStatus]);
